...
(function (global) {
  ...
  var TXT = {
    ...
    // --- intro / nawigacja ---
    "Przejdź przez 14 kroków — zaznacz to, co dla Was ważne. Podgląd tworzy się na bieżąco. Pełny, profesjonalny dokument PDF (z brandem i formatowaniem) otrzymasz po zakupie.": { en: "Go through 14 steps — tick what matters to you. The preview builds live. You'll download the full, professionally formatted PDF after buying a package.", de: "Gehen Sie 14 Schritte durch — markieren Sie, was Ihnen wichtig ist. Die Vorschau entsteht live. Das vollständige, professionell formatierte PDF erhalten Sie nach dem Kauf eines Pakets.", uk: "Пройдіть 14 кроків — позначте те, що для вас важливе. Перегляд формується наживо. Повний, професійно оформлений PDF завантажите після покупки пакета.", ru: "Пройдите 14 шагов — отметьте то, что для вас важно. Предпросмотр формируется в реальном времени. Полный, профессионально оформленный PDF (с брендингом и форматированием) получите после покупки." },
