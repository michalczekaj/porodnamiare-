...
(function (global) {
  ...
  var TXT = {
    ...
    "np. Mamy w domu psa, o którego opiekę chcielibyśmy zapytać personel odwiedzający...": { en: "e.g. We have a dog at home and would like to ask visiting staff about care arrangements...", de: "z. B. Wir haben einen Hund zu Hause und möchten das besuchende Personal nach der Betreuung fragen...", uk: "напр. У нас вдома є собака, про догляд за яким хотіли б запитати персонал, що відвідує...", ru: "напр. У нас дома есть собака, об уходе за которой хотели бы спросить приходящий персонал..." }
  };
