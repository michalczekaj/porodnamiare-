...
(function (global) {
  ...
  var TXT = {
    ...
    // --- intro / nawigacja ---
    "Przejdź przez 16 kroków — zaznacz to, co dla Was ważne. Podgląd tworzy się na bieżąco. Pełny, profesjonalny dokument PDF (z brandem i formatowaniem) otrzymasz po zakupie.": { en: "Go through 16 steps — tick what matters to you. The preview builds live. You'll download the full, professionally formatted PDF after buying a package.", de: "Gehen Sie 16 Schritte durch — markieren Sie, was Ihnen wichtig ist. Die Vorschau entsteht live. Das vollständige, professionell formatierte PDF erhalten Sie nach dem Kauf eines Pakets.", uk: "Пройдіть 16 кроків — позначте те, що для вас важливе. Перегляд формується наживо. Повний, професійно оформлений PDF завантажите після покупки пакета.", ru: "Пройдите 16 шагов — отметьте то, что для вас важно. Предпросмотр формируется в реальном времени. Полный, профессионально оформленный PDF (с брендингом и форматированием) получите после покупки." },
    ...
    "Ustawa gwarantuje prawo do wyrażenia zastrzeżeń co do woli i możliwości karmienia piersią. Niezależnie od Waszej decyzji, personel ma obowiązek uszanować wybór bez oceniania.": { en: "The law guarantees the right to raise reservations about your willingness or ability to breastfeed. Whatever you decide, staff must respect your choice without judgement.", de: "Das Gesetz garantiert das Recht, Vorbehalte hinsichtlich des Willens oder der Möglichkeit zu stillen zu äußern. Unabhängig von Ihrer Entscheidung muss das Personal Ihre Wahl ohne Bewertung respektieren.", uk: "Закон гарантує право висловити застереження щодо волі або можливості годувати грудьми. Незалежно від вашого рішення, персонал зобов'язаний поважати ваш вибір без оцінювання.", ru: "Закон гарантирует право выразить оговорки относительно воли или возможности кормить грудью. Независимо от вашего решения, персонал обязан уважать ваш выбор без оценивания." },
    "Ostatni element wymagany przez Standard 2026: miejsce na Wasze indywidualne uwarunkowania oraz jasny zapis Waszych praw do świadomej zgody na procedury medyczne.": { en: "The final element required by the 2026 Standard: space for your individual circumstances and a clear statement of your right to informed consent for medical procedures.", de: "Das letzte vom Standard 2026 geforderte Element: Raum für Ihre individuellen Umstände sowie eine klare Festlegung Ihres Rechts auf informierte Einwilligung zu medizinischen Eingriffen.", uk: "Останній елемент, якого вимагає Стандарт 2026: місце для ваших індивідуальних особливостей і чіткий запис ваших прав на усвідомлену згоду на медичні процедури.", ru: "Последний элемент, требуемый Стандартом 2026: место для ваших индивидуальных особенностей и чёткая запись ваших прав на осознанное согласие на медицинские процедуры." },
    "Wasza decyzja dotycząca karmienia:": { en: "Your feeding decision:", de: "Ihre Entscheidung zur Ernährung:", uk: "Ваше рішення щодо годування:", ru: "Ваше решение о кормлении:" },
    "Dodatkowe potrzeby:": { en: "Additional needs:", de: "Zusätzliche Bedürfnisse:", uk: "Додаткові потреби:", ru: "Дополнительные потребности:" },
    "Potrzeby szczególne i uwarunkowania": { en: "Special needs and circumstances", de: "Besondere Bedürfnisse und Umstände", uk: "Особливі потреби та обставини", ru: "Особые потребности и обстоятельства" },
    "Zaznaczcie to, co Was dotyczy — szczegóły możecie dopisać w kroku „Dodatkowe uwagi”.": { en: "Tick what applies to you — you can add details in the \u201cAdditional notes\u201d step.", de: "Markieren Sie, was auf Sie zutrifft — Details können Sie im Schritt „Zusätzliche Anmerkungen\u201c ergänzen.", uk: "Позначте те, що вас стосується — деталі можете додати в кроці «Додаткові нотатки».", ru: "Отметьте то, что вас касается — детали можно добавить в шаге «Дополнительные заметки»." },
    "Rejestr świadomej zgody": { en: "Informed consent record", de: "Verzeichnis der informierten Einwilligung", uk: "Реєстр усвідомленої згоди", ru: "Реестр осознанного согласия" },
    "Poniższe punkty potwierdzają Wasze prawa wynikające z Ustawy o prawach pacjenta.": { en: "The points below confirm your rights under the Patients' Rights Act.", de: "Die folgenden Punkte bestätigen Ihre Rechte gemäß dem Patientenrechtegesetz.", uk: "Наведені нижче пункти підтверджують ваші права згідно із Законом про права пацієнта.", ru: "Приведённые ниже пункты подтверждают ваши права согласно Закону о правах пациента." },
    ...
    "Miejsce na wszystko, co dla Was ważne, a nie zmieściło się w pytaniach powyżej. Pole nieobowiązkowe.": { en: "Space for anything that matters to you that wasn't covered by the questions above. This field is optional.", de: "Platz für alles, was Ihnen wichtig ist und in den obigen Fragen nicht vorkam. Dieses Feld ist optional.", uk: "Місце для всього важливого, що не увійшло в питання вище. Поле необов'язкове.", ru: "Место для всего важного, что не вошло в вопросы выше. Поле необязательное." },
    "Coś jeszcze, co chcielibyście przekazać zespołowi opieki?": { en: "Anything else you'd like to tell your care team?", de: "Möchten Sie dem Betreuungsteam noch etwas mitteilen?", uk: "Ще щось, що хочете повідомити команді опіки?", ru: "Что-то ещё, что хотели бы сообщить команде ухода?" },
    "Np. alergie, ważne okoliczności rodzinne, szczególne prośby dotyczące komunikacji. To trafi do Waszego planu porodu jako osobna sekcja.": { en: "E.g. allergies, important family circumstances, specific communication requests. This will be added to your birth plan as a separate section.", de: "Z. B. Allergien, wichtige familiäre Umstände, besondere Wünsche zur Kommunikation. Dies wird als eigener Abschnitt in Ihren Geburtsplan aufgenommen.", uk: "Напр. алергії, важливі сімейні обставини, особливі прохання щодо спілкування. Це потрапить у ваш план пологів як окремий розділ.", ru: "Например: аллергии, важные семейные обстоятельства, особые пожелания по общению. Это попадёт в ваш план родов отдельным разделом." },
    "Podpowiedź: **pogrubienie**, *kursywa*, myślnik na początku linii = punkt listy.": { en: "Tip: **bold**, *italic*, a dash at the start of a line = bullet point.", de: "Tipp: **fett**, *kursiv*, ein Bindestrich am Zeilenanfang = Aufzählungspunkt.", uk: "Підказка: **жирний**, *курсив*, тире на початку рядка = пункт списку.", ru: "Подсказка: **жирный**, *курсив*, тире в начале строки = пункт списка." },
    "np. Mam silny lęk przed igłami — proszę o uprzedzenie przed każdym wkłuciem i chwilę na oddech.": { en: "e.g. I have a strong fear of needles — please warn me before every injection and give me a moment to breathe.", de: "z. B. Ich habe große Angst vor Nadeln — bitte kündigen Sie jede Injektion an und geben Sie mir einen Moment zum Durchatmen.", uk: "напр. У мене сильний страх перед голками — прошу попереджати перед кожним уколом і давати мить на видих.", ru: "напр. У меня сильный страх перед иглами — прошу предупреждать перед каждым уколом и давать момент, чтобы выдохнуть." }
  };
